# Operation Core - MngKeeper token (Odak sunucu / API Gateway)
# Token: $env:TEMP\operationcore_dg_token.txt
#
# Calistir: .\get-operationcore-token.ps1
# Kimlik bilgileri asagidaki MANUEL AYARLAR bolumundedir.

# ========== MANUEL AYARLAR ==========
$DomainName    = "odak"
$Username      = "odak_admin"
$Password      = "Admin123!"
$KeeperBaseUrl = "http://192.168.20.20:5040"
