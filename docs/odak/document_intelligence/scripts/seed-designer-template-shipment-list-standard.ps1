# İş paketi sevkiyat listesi (XLSX) standart şablon seed
#
# Kullanım:
#   .\docs\odak\document_intelligence\scripts\build-shipment-list-seed-xlsx.ps1
#   .\docs\odak\document_intelligence\scripts\seed-designer-template-shipment-list-standard.ps1
#   .\docs\odak\document_intelligence\scripts\seed-designer-template-shipment-list-standard.ps1 -BaseUrl "http://192.168.20.20:5040" -Replace
...
$seedFile = Join-Path $repoRoot "docs/odak/document_intelligence/datasets/seed-designer-template-shipment-list-standard.json"
...
$tpl = $seed.template
$xlsxPath = Join-Path $repoRoot "docs/odak/document_intelligence/sample/$($tpl.xlsxFile)"
if (-not (Test-Path $xlsxPath)) {
    $buildScript = Join-Path $scriptDir "build-shipment-list-seed-xlsx.ps1"
...
Write-Host "Shipment List XLSX seed -> $BaseUrl" -ForegroundColor Cyan
...
Write-Host "Seed tamam. Template id: $templateId - publish icin patch-shipment-list-standard-test.ps1 calistirin." -ForegroundColor Cyan
