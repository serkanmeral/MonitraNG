# Odak Siparis — odak_is_paketleri dataset + Automated Form kurulumu
#
# Usage (repo kokunden):
#   .\docs\odak\operationcore\scripts\get-operationcore-token.ps1
#   .\docs\odak\siparis\scripts\setup-odak-is-paketleri-dataset.ps1
#
# Onkosul: odak_musteriler dataset (setup-odak-master-datasets.ps1)
...
$datasetFile = Join-Path $datasetDir "odak_is_paketleri_dataset.json"
$formFile = Join-Path $datasetDir "odak_is_paketleri_automated_form.json"
...
Write-Host "Odak Siparis — odak_is_paketleri" -ForegroundColor Cyan
...
Write-Host "AF runtime: /apps/automated-forms/view/odak-is-paketleri-form" -ForegroundColor Gray
