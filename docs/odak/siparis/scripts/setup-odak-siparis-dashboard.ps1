# Odak Siparis — global operasyon dashboard (@dashboards kaydi)
#
# Usage (repo kokunden):
#   .\docs\odak\operationcore\scripts\get-operationcore-token.ps1
#   .\docs\odak\siparis\scripts\setup-odak-siparis-dashboard.ps1
#
# UI: http://192.168.20.20:3000/dashboards/odak-siparis
...
$seedFile = Join-Path $scriptDir "..\datasets\odak_siparis_dashboard_seed.json"
...
Write-Host "`n=== setup-odak-siparis-dashboard ===" -ForegroundColor Cyan
...
elseif ($list -is [Array] -and $list.Count -gt 0) { $existing = $list[0] }
...
Write-Host "Dashboard listesi: /apps/dashboards" -ForegroundColor Gray
