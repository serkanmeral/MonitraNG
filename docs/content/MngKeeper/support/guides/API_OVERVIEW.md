...
> 📘 **Not:** Tüm environment değişkenleri için [ENVIRONMENT_VARIABLES.md](../setup/ENVIRONMENT_VARIABLES.md) dosyasına bakınız.
...
> 📘 **Detaylı Döküman:** [ENVIRONMENT_VARIABLES.md](../setup/ENVIRONMENT_VARIABLES.md) - Tüm environment değişkenleri ve kullanım örnekleri
