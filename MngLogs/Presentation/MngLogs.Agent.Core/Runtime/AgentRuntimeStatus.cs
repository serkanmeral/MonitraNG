...
public sealed class AgentRuntimeStatus
{
    ...
    public DateTime? LastJournalUtc { get; private set; }
    ...
    public string? LastJournalError { get; private set; }
    ...
    public long JournalEventsProduced { get; private set; }
    ...
    public void MarkJournalCollected(int count)
    {
        LastJournalUtc = DateTime.UtcNow;
        LastJournalError = null;
        JournalEventsProduced += count;
        Note($"Journal enqueued {count}");
    }

    public void MarkJournalIdle()
    {
        LastJournalUtc = DateTime.UtcNow;
        LastJournalError = null;
    }

    public void MarkJournalError(string error)
    {
        LastJournalError = error;
        Note($"Journal error: {error}");
    }
