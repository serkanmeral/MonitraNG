...
/// <summary>Geçerli minimal boş DOCX (LibreOffice / Collabora ile düzenlenebilir).</summary>
public static class MinimalDocxFactory
{
    ...
    public static byte[] CreateBlank() => CreateWithParagraphText(" ");

    public static byte[] CreateWithParagraphText(string text)
    {
        var docXml = string.IsNullOrEmpty(text)
            ? DocumentXml
            : $"""
               <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
               <w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
