...
/// <summary>Odak Eğitim katılım sertifikası (childRow) — minimal DOCX placeholder'lar.</summary>
public static class ReportingOdakEgitimCertificateDocxFactory
{
    ...
    public static byte[] Create()
    {
        var lines = new[]
        {
            "KATILIM SERTİFİKASI",
            "",
            "Bu belge, aşağıdaki personelin ilgili eğitime katıldığını belgeler.",
            "",
            "Personel: {{personName}}",
            "Eğitim No: {{egitimNo}}",
            "Eğitim: {{baslik}}",
            "Eğitimi Veren: {{egitimVeren}}",
            "Tarih: {{trainingDate}}",
            "Durum: {{durum}}",
            "",
            "Üretim: {{generatedAt}}",
