...
public class UserEventConsumer
{
    ...
    {
        // 1. Soft delete (__isDeleted = true)
        // 2. Retry mechanism ile hata durumunda tekrar dene
    }
}
```
...
db.getCollection("@users").createIndex({ "__isDeleted": 1 });
```
...
db.getCollection("@groups").createIndex({ "__isDeleted": 1 });
```
