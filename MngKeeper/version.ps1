...
$ProjectFiles = @(
    "Presentation/MngKeeper.Api/MngKeeper.Api.csproj",
    "Core/MngKeeper.Application/MngKeeper.Application.csproj",
    "Core/MngKeeper.Domain/MngKeeper.Domain.csproj",
    "Infrastructure/MngKeeper.Infrastructure/MngKeeper.Infrastructure.csproj",
    "Infrastructure/MngKeeper.Persistence/MngKeeper.Persistence.csproj"
)
