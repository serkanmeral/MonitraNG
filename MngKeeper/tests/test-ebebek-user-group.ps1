# Test User and Group Creation for Ebebek Domain
Write-Host "`n=== Test Ebebek User/Group Creation ===" -ForegroundColor Green

$baseUrl = "https://localhost:5001/api"

# Step 1: Get Token for Ebebek Domain
Write-Host "`n[1/3] Getting token for Ebebek domain..." -ForegroundColor Cyan
...
$groupBody = @{
    ...
    description = "Test group for Ebebek domain"
...
Write-Host "✅ Domain: ebebek" -ForegroundColor Green
Write-Host "✅ Database: mng_ebebek" -ForegroundColor Green
if ($groupId) {
...
Write-Host "   Database: mng_ebebek" -ForegroundColor Yellow
...
Write-Host "   use mng_ebebek" -ForegroundColor Gray
if ($userId) {
