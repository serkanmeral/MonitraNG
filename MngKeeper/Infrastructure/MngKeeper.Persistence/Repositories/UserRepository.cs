    ...
    public class UserRepository : IUserRepository
    {
        ...
        private User? MapBsonDocumentToUser(BsonDocument? doc)
        {
            ...
            return new User
            {
                ...
                TelegramUsername = doc.Contains("telegramUsername") && !doc["telegramUsername"].IsBsonNull ? doc["telegramUsername"].AsString : null,
                TelegramChatId = doc.Contains("telegramChatId") && !doc["telegramChatId"].IsBsonNull ? doc["telegramChatId"].AsString : null,
                TelegramLinkedAt = doc.Contains("telegramLinkedAt") && !doc["telegramLinkedAt"].IsBsonNull ? doc["telegramLinkedAt"].ToUniversalTime() : null,
        ...
        public async Task<User> AddAsync(User entity)
        {
            try
            {
                ...
                var document = new BsonDocument
                {
                    ...
                    ["department"] = string.IsNullOrEmpty(entity.Department) ? BsonNull.Value : entity.Department,
                    ["gender"] = (int)entity.Gender,
                    ["phoneNumber"] = string.IsNullOrEmpty(entity.PhoneNumber) ? BsonNull.Value : entity.PhoneNumber,
                    ["telegramUsername"] = string.IsNullOrEmpty(entity.TelegramUsername) ? BsonNull.Value : entity.TelegramUsername,
                    ["telegramChatId"] = string.IsNullOrEmpty(entity.TelegramChatId) ? BsonNull.Value : entity.TelegramChatId,
                    ["telegramLinkedAt"] = entity.TelegramLinkedAt.HasValue ? entity.TelegramLinkedAt.Value : BsonNull.Value,
