...
public class BackendServices
{
    ...
    public string MngWorkflow { get; set; } = "http://mngworkflow:5085";
    public string MngAlarm { get; set; } = "http://mngalarm:5087";
    public string MngOperations { get; set; } = "http://mngoperations:5086";
