...
import OcAdminApprovalsExplorer from '@/components/apps/operation-core/admin/OcAdminApprovalsExplorer.vue';
...
<template>
  <div class="oc-flow oc-admin-approvals-page">
    <BaseBreadcrumb
