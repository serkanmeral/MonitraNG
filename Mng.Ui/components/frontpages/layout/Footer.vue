...
import Logo from '@/components/lc/Full/logo/LogoLight.vue';
import LogoIcon from '@/components/lc/Full/logo/LogoIcon.vue';
</script>

<template>
    <div class="front-dark bg-textPrimary">
            ...
            <div class="space-p-96">
                <v-row>
                    <v-col cols="12" lg="3" sm="6">
                        ...
                        <div class="d-flex flex-column ga-4 mt-lg-n1">
                    ...
                    <v-col cols="12" lg="3" sm="6">
                        <h5 class="text-17 mb-sm-8 mb-6  text-white">Features</h5>
                    ...
                    <v-col cols="12" lg="3" sm="6">
                        <h5 class="text-17 mb-sm-8 mb-6  text-white">Resources</h5>
                        <div class="d-flex flex-column ga-4">
                    ...
                    <v-col cols="12" lg="3" sm="6">
                        <h5 class="text-17 mb-sm-8 mb-6  text-white">Follow us</h5>
            ...
            <div class="py-sm-10 py-6">
                <div class="d-sm-flex justify-space-between">
                    <div class="d-flex ga-2  justify-sm-start justify-center">
                        <LogoIcon/>
                        <span class="
                        text-white text-15 opacity-80">All rights reserved by MaterialPro.</span>   
                    </div>
