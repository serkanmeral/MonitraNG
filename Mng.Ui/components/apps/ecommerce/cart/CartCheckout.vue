  ...
  <v-card elevation="10">
    <v-card-text>
      <v-tabs v-model="tab" color="primary" class="customTab">
        ...
        >
          <span
            class="round-40 rounded-circle bg-grey100 d-flex justify-center align-center me-3 icon"
          >
          ...
          <div>
            ...
            <span
              class="text-subtitle-2 textSecondary font-weight-medium d-block"
      ...
      <v-window v-model="tab">
        ...
        <v-window-item value="tab-2" class="pa-1">
          ...
          <v-row class="mt-3">
            <v-col cols="6">
              <v-btn color="primary" variant="tonal" @click="changeTab('tab-1')"
                >Back</v-btn
              >
            </v-col>
        ...
        <v-window-item value="tab-3" class="pa-1">
          ...
          <v-row class="mt-3">
            <v-col cols="12" sm="6">
              <v-btn color="primary" variant="tonal" @click="changeTab('tab-2')"
                >Back</v-btn
              >
            </v-col>
            <v-col cols="12" sm="6" class="text-sm-right">
              <v-btn color="primary" @click="thankyou = true"
