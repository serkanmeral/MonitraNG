    ...
    <div v-if="store.selectedEmail" class="email-detail">
        ...
        <div class="d-flex align-center justify-space-between mb-7">
            <div class="d-flex align-center ga-3">
                ...
                <div>
                    <h6 class="text-14 lh-normal font-weight-semibold">{{ store.selectedEmail.from }}</h6>
        ...
        <h5 class="text-20 font-weight-semibold" >{{ store.selectedEmail.subject }}</h5>
        ...
        <div v-if="store.selectedEmail.attchments != 0">
            ...
            <h6 class="text-14 mb-3 font-weight-semibold">Attachments</h6>
            <v-row>
                <v-col cols="12" md="4" v-for="item in store.selectedEmail.attchments" :key="item.id">
                    <div class="d-flex align-center ga-3">
                        ...
                        <div>
                            <h5 class="text-14 lh-normal cursor-pointer hover-primary font-weight-semibold" >
                                {{ item.title }}
                            </h5>
