            ...
            <div class="overflow-x-reposive">
                <v-row class="d-flex flex-nowrap">
                    <v-col cols="10" md="3" sm="6">
                        <div class="bg-lightsecondary pa-7 text-center cursor-pointer rounded-md" @click="setTicketType('total')">
                            <h2 class="text-secondary text-24">{{ totalTicketCount }}</h2>
                            <h6 class="text-secondary text-h6">Total Tickets</h6>
                        </div>
                    </v-col>
                    <v-col cols="10" md="3" sm="6">
