        ...
        <v-col cols="12" md="9">
            <v-card elevation="10">
                <v-card-item>
                    ...
                    <div class="text-subtitle-1 text-textPrimary opacity-80 text-10 my-3">
                    ...
                    <div class="mt-6">
                        ...
                        <span class="text-subtitle-1 text-textPrimary opacity-80">Required for notificaitons.</span>
                    </div>

                    <div class="d-flex align-sm-center align-start mt-7" v-for="list in notificationTb" :key="list.title">
                        <v-avatar size="48" class="mr-2" rounded="md" color="lightsecondary">
                            <component :is="list.icon" stroke-width="2" size="22" />
                        </v-avatar>
                        <div class="pl-4">
                            <h6 class="text-h6 mb-3 mt-n1">{{ list.title }}</h6>
                            <h5 class="text-subtitle-1 text-textPrimary opacity-80">{{ list.subtitle }}</h5>
                        </div>
        ...
        <v-col cols="12" md="9">
            <v-card elevation="10">
                <v-card-item>
                    ...
                    <div class="text-subtitle-1 text-textPrimary opacity-80 text-10 my-3">Time zones and calendar display settings.</div>
                    <div>
                        <div class="d-flex align-center mt-7">
                            ...
                            <div class="pl-4">
                                <h5 class="text-subtitle-1 text-textPrimary opacity-80 mb-1">Time zone</h5>
                                <h6 class="text-h6">(UTC + 02:00) Athens, Bucharet</h6>
                            </div>
                            <div class="ml-auto">
                                <v-btn size="30" icon  class="lightsecondary d-flex">
                                    <v-avatar size="30">
                    ...
                    <div>
                        <div class="d-flex align-center mt-7">
                            ...
                            <div class="pl-4">
                                ...
                                <h5 class="text-subtitle-1 text-textPrimary opacity-80">Browser Cookie</h5>
                            </div>
                            <div class="ml-auto mr-1 pa-sm-0 pl-sm-1 pa-6 pl-7">
