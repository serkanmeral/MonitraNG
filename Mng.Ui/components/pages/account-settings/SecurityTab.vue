    ...
    <v-card elevation="10" >
        <v-row class="ma-sm-n2 ma-n1">
                ...
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="d-sm-flex justify-space-between mt-4 mb-8">
                            <div class="text-subtitle-1 text-textPrimary opacity-80 text-13 pr-5">
                        ...
                        <div class="d-flex justify-space-between my-4">
                            <div>
                                ...
                                <h5 class="text-subtitle-1 text-textPrimary opacity-80">Google auth app</h5>
                            </div>
                            <v-btn class="bg-lightsecondary text-primary" flat>Setup</v-btn>
                        </div>
                        <v-divider></v-divider>
                        <div class="d-flex justify-space-between my-4">
                            <div>
                                <h6 class="text-h6 mb-1">Another e-mail</h6>
                                <h5 class="text-subtitle-1 text-textPrimary opacity-80">E-mail to send verification link</h5>
                            </div>
                            <v-btn class="bg-lightsecondary text-primary" flat>Setup</v-btn>
                        </div>
                        <v-divider></v-divider>
                        <div class="d-flex justify-space-between my-4">
                            <div>
                                ...
                                <h5 class="text-subtitle-1 text-textPrimary opacity-80">Your phone number or something</h5>
                            </div>
                            <v-btn class="bg-lightsecondary text-primary" flat>Setup</v-btn>
                        </div>
                    </v-card-item>
            ...
            <v-col cols="12" md="4">
                <v-card elevation="10">
                    <v-card-item>
                        <v-avatar size="48" class="" rounded="md" color="lightsecondary">
                            <DeviceLaptopIcon class="text-primary" size="25" />
                        </v-avatar>
                        <h5 class="text-h5 mt-4">Devices</h5>
                        <div class="text-subtitle-1 mt-3 text-textPrimary opacity-80 text-10">
                        ...
                        <div class="mt-sm-8 mt-5">
                            <div class="d-flex align-center my-4">
                                ...
                                <div class="ml-3 pr-3">
                                    ...
                                    <h5 class="text-subtitle-1 text-textPrimary opacity-80">London UK, Oct 23 at 1:15 AM</h5>
                                </div>
                                <v-btn size="30" icon variant="flat" class="lightsecondary ml-auto">
                                    <v-avatar size="20">
                                        <DotsVerticalIcon />
                                    </v-avatar>
                                </v-btn>
                            ...
                            <div class="d-flex align-center my-4">
                                ...
                                <div class="ml-3 pr-3">
                                    ...
                                    <h5 class="text-subtitle-1 text-textPrimary opacity-80">Gujarat India, Oct 24 at 3:15 AM</h5>
                                </div>
                                <v-btn size="30" icon variant="flat" class="lightsecondary ml-auto">
                                    <v-avatar size="20">
                                        <DotsVerticalIcon />
                        ...
                        <v-btn class="bg-lightsecondary text-primary mt-5" block flat>Need Help?</v-btn>
                    </v-card-item>
                </v-card>
            </v-col>
        </v-row>
