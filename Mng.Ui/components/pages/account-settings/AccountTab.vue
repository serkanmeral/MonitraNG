            ...
            <v-col cols="12" sm="6">
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 text-textPrimary opacity-80 mt-2">Change your profile picture from here</div>
                        <div class="text-center mt-6 mb-6">
                            <v-avatar size="120">
                                <img src="/images/profile/user2.jpg" height="120" alt="image" />
                            </v-avatar>
                        </div>
                        ...
                        <div class="text-subtitle-1 text-textPrimary opacity-80 text-center my-sm-8 my-6">Allowed JPG, GIF or PNG. Max size of 800K</div>
                    </v-card-item>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6">
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 text-textPrimary opacity-80 mt-2">To change your password please confirm here</div>
                        <div class="mt-5">
            ...
            <v-col cols="12">
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 text-textPrimary opacity-80 mt-2">To change your personal detail , edit and save from here</div>
                        <div class="mt-5">
                            <v-row>
                                <v-col cols="12" md="6">
